...
public class JavaScriptUtil {
	...
	public String verifyMandatoryField(String value,String pesudoValue) {
		String script = "return window.getComputedStyle(document.querySelector(\"label[for='"+value+"']\"),'::"+pesudoValue+"').getPropertyValue('content');";
		 String mand_check = js.executeScript(script).toString();
			return mand_check;
	}
