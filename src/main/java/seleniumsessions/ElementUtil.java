...
public class ElementUtil {
	...
	public void Search(By searchField, By suggestions, String searchKey, String suggName) throws InterruptedException {
		...
		Thread.sleep(2000);
		List<WebElement> sugg_list = getElements(suggestions);
	...
	public WebElement waitForPresenceOfElement(By locator, int timeOut, int pollingTime) {
	...
	/**
	 * An expectation for checking that there is at lease one element present on the
	 * a web page.
	 * 
	 * @param locator
	 * @param timeOut
	...
	/**
	 * Waits for the web page title to contain a specified fraction of the expected
	 * title.
	 * 
	 * @param titleFraction
	 * @param timeOut
